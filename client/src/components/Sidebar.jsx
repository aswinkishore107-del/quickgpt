...
const Sidebar = ({isMenuOpen,setIsMenuOpen}) => {
  ...
  return (
    ...
    transition-all duration-500 max-md:absolute left-0 z-1 ${!isMenuOpen && 
      ...
      dark:border-white/20 rounded-md'>
        ...
        <input onChange={(e)=>setSearch(e.target.value)} value={search} type="text" placeholder='Search coversations' className='text-xs
